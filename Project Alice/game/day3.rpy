label day3:
    ...
    "{i}It’s the third day that you are in Alice’s house. Although you realized Alice is \"dangerous\", as a detective, you definitely know there are more to discover.{/i}"

    "{i}The warm sunlight shines on the Whitley’s white, soft, and comfortable quilt through the round windows in front of the bed. However, the walls that are painted in gray sometimes makes you think of interrogation rooms in your office for no reason.{/i}"
    
    "{i}It’s 8:00 am, and you sit on your bed, yawning and looking through the window.{/i}"

    w "What a special day~ People in our town can seldom enjoy such bright and clear sunshines during the winter."

    w "I need to wake Alice up and invite her to go outside, enjoying this lovely day. Maybe we can have breakfast in the sunlight.(Whiteley can't help smiling)"
    ...
    w "Calm down, Alice. Everyting will be alright."
    w "Alice, crying can’t help with anything. What happened Alice?"
    a "Mr.Rabbit is gone, and I can’t find him."
    w "Mr.Rabbit? A fluffy toy? I can help you find it later, but don’t cry for now, okay?"
    ...
    w "I know, when I was a kid, I cherished my little cat toy as much as you do. Do you remember the last place you play with it?"
    "{i}Alice is not in a good mood to think about it.{/i}"
    a "I don’t know, and I don’t remember!"
    w "Okay, fine, fine. We don’t think about the place. Look outside the window, what a beautiful day. Do you want to join me to have breakfast in the sunlights?"
    a "But I want to have breakfast with my Mr. Rabbit.(calm down a little bit, but still sad)"
    w "Maybe Mr. Rabbit is waiting for you in the dining room. Let’s take a look."
    ...
    w "Actually, I find him in a huge tea pot. Maybe he wants to have a cup of tea."
...
label d3_choice1_B:
    scene bg dining room
    a "Why can't you play with with me?I never have a chance to go outside and have a tea party. Don't you like the sunshines?"
    "{i}You can't refuse Alice's request and decide to play with her."
    w "Fine, let's go outside."
    a "Yeah! I'll bring out my tea set!"
...
label d3_choice1_A:
    ...
    w "It sounds childish but interesting.I’ll follow her anyway since she is just a child."
    w "Got it, godmother."
...
label question_alice:
    ...
    w "Alice, isn’t that too extreme to control your child’s thoughts as a godmother?"
    ...
    w "No, no, my Alice, I’m not blaming you, and you’re right. Oh, don’t cry honey. Let’s keep playing."
...
label d3_wonderland:
    ...
    nvl show dissolve
    nvlp "Dear Alice,"
    nvlp "Maybe this will surprise you. The world of Wonderland is real. Mr.Rabbit is the gift from the White queen. It gives us the power to protect you."
    nvlp "Now, we want to give it to you as if we are still staying with you. When you are in danger, use Mr.Rabbit to protect yourself."
    nvl clear
    ...
    nvl clear
    nvld "I don’t want to break my parents’ hearts. I even don’t really know that making friends can make them so sad. I don’t mean that I will leave them. Actually, I really love them."
    nvld "Maybe it’s not the right thing to make friends. I will stay with my parents forever."
    nvl clear
    ...
    label d3_end:
        ...
        with Dissolve(0.5)
        "{i}As you keep reading the books, you hear Whitley’s voice.You hurry to put everything back to normal, and lock the door of the study room. You don’t notice that it’s already 5pm."
