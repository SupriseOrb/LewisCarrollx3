...
label day1:
    ...
    $ timer_jump = 0
    $ day1has_bone = False
    "With a new day, comes a new case. I, Detective Whitley Leveret, am in charge of uncovering the Hearts’ case."
    "The Hearts were a prosperous family, with two loving parents and an adorable child."
    "However, in this time of civil unrest, the parents disappeared without a trace. Some say it was because they dabbled in black magic, others say they were killed in the protests at night."
    "My job is to go through these rumours and find which one is true. That’s why I am going to the heart of this mess: to the Hearts’ Paris Mansion."
    "It looks like I’m almost there. "

    "Before I arrive, I should review the details first. I take out the familiar letter."
    "I’ll be going undercover in this case . Once I reach that mansion, I will be temporary Nanny Whitley, a young college student looking after the orphaned Alice Hearts for some quick cash."
    "It seems the old nanny ran away, giving me an excuse to explore the mansion. However, I only have seven days to snoop around before Alice’s godparents arrive and clear the mansion."
    "That’s more than enough time."

    "The mansion comes into view. A very grand mansion smacked in the middle of Paris, a blooming flower in a field full of weeds."
    "Near the mansion gates is a young girl dressed in a simple blue dress and holding onto an overstuffed life-size white rabbit. That must be Alice."
    "I place the letter back into my pocket, and exit the car. I hurriedly walk towards Alice, carrying my luggage over the uneven gravel from last night’s protest."
    ...
    a "Hello Ms. Whitley. I am Alice Hearts and this is Mr. White Rabbit"
    ...
    "In the end, she’s still just a kid."
    menu:
...
label day1c1a1:
    ...
    "Alice crumples her dress and looks down with a sour face."
...
label day1c1a2:
    ...
    w "Okay, okay. I’ll l play with you."
...
label day1c2a1:
    "I should do as she says. If I want to get any information out of her, I need Alice to trust me."
    w "Closing my eyes."
...
label day1playr1:
    ...
    menu:
        "Tell Alice you're too tiny to play or go along with Alice's antics":
            jump day1c3a1
        "Tell Alice you're too tiny to play":
            jump day1c3a2
label day1c3a1:
    w "But Alice how can we catch all the pieces if we’re so tiny?"
    "Alice smiles amusingly at Whitley."
    a "Why don’t you try first, Ms. Whitley?"
    w "That doesn’t answ--"
    a "Look the red piece is in the air! The game’s already starting."
    "I looked up and low and behold, the red piece was thrown in the air. But who did that? Alice and I weren't near it. I looked back at Alice, who was already next to a regular piece. Once Alice touched the metal piece, it shrunken until it fit in Alice’s palm."
    "So that’s how we can get the pieces. I looked around for any more pieces, but it seems like there was only one."
...
label day1playr2:
    "Alice throws the metal piece away from us. Once the metal piece settled, it returned to its original size. There was another metal piece a little farther away...when did it get there?"
    "I eyed the red metal piece, ready for the second round to start. Alice taps my shoulder, but I only glance at her."
...
label day1c4a1:
    ...
    w "Well, … is good. … is also a wonderful dish. Do desserts count?"
    "Wait, why am I so focused on this one question. We’re in the middle of a game. I looked for the red piece, the signal from the start of the round. It’s already up in the air and starting it’s descent down. Alice also has one of the metal pieces already."
...
label day1c4a2:
    ...
    "I patted Alice’s head. I probably have fun, but I can’t be distracted from the game."
    jump day1playr2cont

label day1c4a3:
    w "Food"
    "One of the worst answers, but I have to keep my focus off of the red piece."
    jump day1playr2cont
...
label day1playr2cont:
    ...
    w "Well, I wasn’t trying to trick my opponent into forgetting that we’re in a game."
